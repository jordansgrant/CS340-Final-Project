...
document.addEventListener('DOMContentLoaded', function() {
	...
	/*CS340 Final Project Client Code
		The following sections of code handle different client side requests to
		theserver and then display results based on the response. Each section
		follows aproximately the same format and so will only be explained once
	*/

	document.getElementById('insert_tree').addEventListener('click', function() {
		//upon being clicked the following variables are populated from the
		//appropriate dom form.
		...
		//The 'GET' query is generated below for attachment to the request
		...
		//The request address and query are compiled here
		query = address + '/insert-tree' + query + '&callback=?';

		//The request is made to the server and then handled based on
		//error or a good result. Typically relevant data is "alerted"
	...
	//The following sections of code redirect to relevant content display
